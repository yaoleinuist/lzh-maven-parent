...
/**
 * Author:zhiming.xu 多线程的断点下载程序,根据输入的url和指定线程数,来完成断点续传功能。
...
public class MultiTheradDownLoad {
	...
	public static void main(String[] args) {
		String filepath = "http://tsp-device-images.oss-cn-hangzhou.aliyuncs.com/WechatIMG57-bddb512e05764ae2902ba5fd0d2ce8b3.jpeg";
