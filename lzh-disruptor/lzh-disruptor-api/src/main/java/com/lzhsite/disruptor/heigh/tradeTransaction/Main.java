...
public class Main {
    public static void main(String[] args) throws InterruptedException, ExecutionException {  
         ...
         */  
        final RingBuffer<TradeTransactionEvent> ringBuffer = RingBuffer.createSingleProducer(new EventFactory<TradeTransactionEvent>() {  
            @Override  
        ...
        //创建消息处理器  
        BatchEventProcessor<TradeTransactionEvent> transProcessor = new BatchEventProcessor<TradeTransactionEvent>(  
        ...
        //如果存在多个消费者 那重复执行上面3行代码 把TradeTransactionEventInDBHandler换成其它消费者类  
