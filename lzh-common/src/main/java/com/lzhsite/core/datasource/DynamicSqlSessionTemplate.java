...
public class DynamicSqlSessionTemplate implements SqlSession{
    ...
    public DynamicSqlSessionTemplate(SqlSessionTemplate sqlSessionTemplate) {
        ...
        SqlSessionInterceptor interceptor = new SqlSessionInterceptor(sqlSessionTemplate);
        this.sqlSessionProxy = (SqlSession) newProxyInstance(
                sqlSessionTemplate.getClass().getClassLoader(),
    ...
    private class SqlSessionInterceptor implements InvocationHandler {
        ...
        public SqlSessionInterceptor(Object target) {
            this.target = target;
        }
